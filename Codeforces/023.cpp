...
void solve()
{
    ...
    auto good_grid=grid; // can be copied in a single line
    for(int i=0;i<n;i++) sort(good_grid[i].begin(),good_grid[i].end());
    //for(auto it:good_grid) for(auto it2:it) cout<<it2<<" ";
